        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={[styles.container, { backgroundColor: theme.colors.background }]}>
                ...
                <SegmentedButtons
                    ...
                    buttons={[
                        { value: 'income', label: 'Gelir', style: { backgroundColor: type === 'income' ? theme.colors.customIncome + '20' : undefined } },
                        { value: 'expense', label: 'Gider', style: { backgroundColor: type === 'expense' ? theme.colors.customExpense + '20' : undefined } },
                    ]}
                    style={styles.input}
                />
